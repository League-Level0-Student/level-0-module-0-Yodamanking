...
public class DragonFight {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// 4. If they typed in "yell":
					if (answer.equals("yell")) {
						...
						JOptionPane.showMessageDialog(null, "You yell at the dragon for " + playerAttack + " damage!");
				...
				// 5. If they typed in "kick":
					if (answer.equals("kick")) {
						...
						dragonHealth -= playerAttack;
						JOptionPane.showMessageDialog(null, "You kick the dragon for "+ playerAttack + " damage!");
					}
			...
			// THE DRAGON RETALIATES
				...
				// 6. Find a random number between 0 and 35 and store it in dragonAttack
					...
					JOptionPane.showMessageDialog(null, "The dragon deals " + dragonAttack + " damage!");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "You beat the dragon and you got a ton of gold!");
		System.exit(0);   //This code ends the program
	}
